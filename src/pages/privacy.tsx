...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;Flow Safe&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a mobile
    ...
    <h4>4.1. When visiting our website and using Flow Safe</h4>
    <p>
      When visiting our website or using Flow Safe, we may collect and process personal data. The data will be stored in
      different instances
    </p>
    <ol>
      <li>
    ...
    <ol start={8}>
      <li>
        When we collect relevant&nbsp;data&nbsp;from the Blockchain to display context information in the Flow Safe we
        process:
        <ol>
          <li>your public Wallet address, </li>
          <li>account balance,</li>
    ...
    <p>
      4.2.2 For general operational analysis of the Flow Safe interface, monitoring transaction origins and measuring
    ...
    <p>
      In addition, we may take a recording of you while testing Flow Safe for internal and external use. The basis for
    ...
    <p>
      Flow Safe mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the Flow Safe mobile app via biometrics information (touch ID or face ID). This is a
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with Flow Safe. For enhanced
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>Flow Safe – Privacy policy</title>
      </Head>
